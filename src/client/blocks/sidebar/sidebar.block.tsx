...
const htmlSidebar = {
    title: "ТИПЫ ТЕГОВ",
    items: [
        { icon: "html5-icon", text: "HTML5" },
        { icon: "block-element-icon", text: "Блочные элементы" },
        { icon: "line-item-icon", text: "Строчные элементы" },
        { icon: "build-icon", text: "Универсальные элементы" },
        { icon: "warning-icon", text: "Нестандартные теги" },
        { icon: "bug-icon", text: "Осуждаемые теги" },
        { icon: "video-icon", text: "Видео" },
        { icon: "file-icon", text: "Документ" },
        { icon: "volume-icon", text: "Звук" },
        { icon: "image-icon", text: "Изображения" },
        { icon: "extension-icon", text: "Объекты" },
        { icon: "script-icon", text: "Скрипты" },
        { icon: "list-numbered-icon", text: "Списки" },
        { icon: "link-icon", text: "Ссылки" },
        { icon: "table-icon", text: "Таблицы" },
        { icon: "text-icon", text: "Текст" },
        { icon: "formatting-icon", text: "Форматирование" },
        { icon: "forms-icon", text: "Формы" },
        { icon: "frame-icon", text: "Фреймы" }
    ]
};
const cssSidebar = {
    title: "КАТЕГОРИИ CSS",
    items: [
        { icon: "regulation-icon", text: "@-правила" },
        { icon: "animation-icon", text: "Анимация" },
        { icon: "gradient-icon", text: "Градиент" },
        { icon: "border-icon", text: "Границы" },
        { icon: "image-icon", text: "Изображения" },
        { icon: "interface-icon", text: "Интерфейс" },
        { icon: "content-icon", text: "Контент" },
        { icon: "line-item-icon", text: "Отступы" },
        { icon: "print-icon", text: "Печать" },
        { icon: "position-icon", text: "Позиционирование" },
        { icon: "fields-icon", text: "Поля" },
        { icon: "pseudoclasses-icon", text: "Псевдоклассы" },
        { icon: "pseudoelements-icon", text: "Псевдоэлементы" },
        { icon: "dimensions-icon", text: "Размеры" },
        { icon: "rounded-icon", text: "Скруглённые уголки" },
        { icon: "list-numbered-icon", text: "Список" },
        { icon: "table-icon", text: "Таблица" },
        { icon: "text-icon", text: "Текст" },
        { icon: "formatting-icon", text: "Форматирование" },    
        { icon: "background-color-icon", text: "Цвет и фон" },    
        { icon: "font-icon", text: "Шрифт" }    
    ]
};
