...
export class Navigation extends React.Component<any, State> {
    constructor(props) {
        super(props);
    ...
    render1(directory, activeDirectory) {
        return (
            <div
                onClick={() => this.setState({
                    activeDirectory: (activeDirectory == directory.categoryName) ? "" : directory.categoryName
                })}
    ...
    render3(category) {
        if (category && category.childrens && category.childrens.length > 0) {
            return (
    ...
    render() {
        ...
        return (
            <nav className={styles.navigation}>
                { navInfo.map(directory => {
                    return this.render1(directory, activeDirectory)
                })}
            </nav>
        );
    }
