                ...
                <div className={styles.textBlock}>
                    <div className={styles.textWrapper}>
                        ...
                        <Paragraph className={styles.paragraph}>
                            Мы группа работающих специалистов по веб-разработке и разработчики открытого исходного кода, предоставляем вам краткие, 
                            насыщенные информацией видео-курсы о лучших инструментах в веб-разработке.
                        </Paragraph>
                        <Paragraph className={styles.paragraph}>
                            Мы уважаем ваше время. Цель этой платформы — 
                            предоставить как можно более грамотную и структурированную информацию для обучения.
                        </Paragraph>
                    </div>
                </div>
