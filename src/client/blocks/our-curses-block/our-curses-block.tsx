...
import htmlCssImage from 'Assets/images/other/html-css.png';
...
const data = [
  ...
  },
  {
    ...
    text: 'Изучаем основы HTML и CSS. На практике разбираемся с '
        + 'семантической разметкой и базовыми механизмами стилизации на примере небольшого сайта.',
    color: 'blue',
